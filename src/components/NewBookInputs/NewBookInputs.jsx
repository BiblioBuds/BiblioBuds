  ...
  const handleSubmit = async (event) => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <h1 className="text-slate-900 text-3xl text-center mt-3"> Upload a new Book</h1>
            <div className="mx-4 mt-3 h-20 grid grid-cols-3 gap-5 justify-center">
                <div className="justify-center flex flex-col">
                    ...
                    <p className="align-bottom text-center text-red-500 text-sm mt-1" >{errors.title}</p>
                </div>
                <div className="justify-center flex flex-col">
                    ...
                    className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-8 hover:bg-stone-200 p-2 placeholder:italic"></input>
                    <p className="align-bottom text-center text-red-500 text-sm mt-1" >{errors.author}</p>
                </div>
                <div className="justify-center flex flex-col">
                    ...
                    className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-8 hover:bg-stone-200 p-2 placeholder:italic"></input>
                    <p className="align-bottom text-center text-red-500 text-sm mt-1" >{errors.editorial}</p>
                </div>
            </div>
            <div className="mx-4 mt-4 h-20 grid grid-cols-3 gap-5">
                <div className="justify-center flex flex-col">
                    <h1 className="text-black text-center pb-1">Genre</h1>
                    <select id="genres" name="genres" className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-8  hover:bg-stone-200" onChange={handleChange}>
                ...
                <div className="justify-center flex flex-col">
                    ...
                    placeholder="15.99"
                    className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-8 hover:bg-stone-200 p-2 placeholder:italic"></input>
                    <p className="align-bottom text-center text-red-500 text-sm mt-1" >{errors.price}</p>
                </div>
                <div className="justify-center flex flex-col">
                    ...
                    placeholder="223"
                    className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-8 hover:bg-stone-200 p-2 placeholder:italic"></input>
                    <p className="align-bottom text-center text-red-500 text-sm mt-1" >{errors.pages}</p>
                </div>
            </div>
            <div className="mx-4 mt-4 h-20 grid grid-cols-3 gap-5">
                <div className="justify-center flex flex-col">
                    <h1 className="text-black text-center pb-1">Language</h1>
                    <select id="languages" name="languages" className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-8  hover:bg-stone-200" onChange={handleChange}>
                ...
                <div className="justify-center flex flex-col">
                    ...
                    <select id="formats" name="formats" className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-8 hover:bg-stone-200" onChange={handleChange}>
                ...
                <div className="justify-center flex flex-col">
                    ...
                    placeholder="20"
                    className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-8 hover:bg-stone-200 p-2 placeholder:italic"></input>
                    <p className="align-bottom text-center text-red-500 text-sm mt-1" >{errors.stock}</p>
                </div>
            </div>
            <div className="mx-4 mt-4 h-20 grid grid-cols-2 gap-5">
                <div className="justify-center flex flex-col">
                    ...
                    className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-8 hover:bg-stone-200 p-2 placeholder:italic"></input>
                    <p className="align-bottom text-center text-red-500 text-sm mt-1" >{errors.date}</p>
                </div>
                <div className="justify-center flex flex-col">
            ...
            <div className="mx-4 mt-4 h-24 grid grid-cols-1 gap-5 mb-6">
                <div className="justify-center flex flex-col">
                    ...
                    className="text-black justify-center mx-2 rounded-lg bg-stone-100 shadow-slate-600 shadow-md h-20 resize-none box-border pl-2 hover:bg-stone-200 p-2 placeholder:italic"></textarea>
                    <p className="align-bottom text-center text-red-500 text-sm mt-1" >{errors.synopsis}</p>
                </div>
            </div>
