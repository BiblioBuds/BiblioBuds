...
const AccountPage = () => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-lg mb-4">
      ...
      {isEditing ? (
        ...
        <button
          ...
          className="px-4 py-2 text-white bg-purple-200 rounded-lg hover:bg-blue-300 focus:outline-none mt-2"
        >
          Editar
        </button>
      )}
